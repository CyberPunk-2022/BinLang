      ...
      <div class="header-search">
        <div
          ...
          <div style="display: inline-block">
            <button style="background-color: #1d231e;
            color:white;width:70px;border-radius: 10px;height: 35px;line-height: 25px">搜索
            </button>
          </div>
        </div>
        <a href="#">
          ...
          >
            <video-page
              ...
              <template v-slot:right-menu>
                ...
                <div class="right-item-icon">
                  <!-- 喜欢-->
                  <van-icon name="like" size="40" badge="9" @click="clickFunc('like')"/>
                </div>
                <!-- 评论-->
                <div class="right-item-icon">
                  <van-icon name="chat" size="40" badge="9" @click="clickFunc('chat')"/>
                </div>
                <!-- 收藏-->
                <div class="right-item-icon">
                  <van-icon name="star" size="40" badge="9" @click="clickFunc('star')"/>
                </div>
                <!-- 分享-->
                <div class="right-item-icon">
                  <van-icon name="share" size="40" badge="9" @click="clickFunc('share')"/>
                </div>
              </template>
